...
//            Log.w(TAG, e);
    ...
    public static String getRegionDisplayName(String regionCode, String locale) {
        Locale loc = new Locale(locale);
        return (regionCode == null || regionCode.equals("ZZ") || regionCode.equals(PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY))
                ? "Unknown country" : new Locale("", regionCode).getDisplayCountry(loc/*Locale.getDefault()*/);
    }
