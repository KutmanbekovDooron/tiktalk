...
class ChatSingleActivity : BaseInjectActivity(), ChatSingleContract.View, AttachFileDialog.AttachFileClickListener, SelectListener {
...
//        adapter?.notifyItemChanged(/*pos*/presenter.chats.size-1)
    ...
    private fun setupToolbar() {
        ...
        toolbarBtnCamera.setOnClickListener {
            ...
            val callToUser = CallToUser(presenter.opponentIdentity, presenter.opponentName, presenter.opponentPhoto, presenter.channelSid)
    ...
    override fun openPIN(viaVisibility: Boolean) {
        if (canOpen())
            PinLockerActivity.startActivity(this, viaVisibility = viaVisibility, channelSid = presenter.channelSid)
    }
    ...
    private fun openCamera() {
        ...
        RxPermissions(this)
            ...
            .subscribe ({ permission ->
                if (permission.granted) {
                    ...
                    if (grantedPermCount == 2) {
                        ...
                        if (cameraIntent.resolveActivity(packageManager) != null) {
                            ...
                            this@ChatSingleActivity.startActivityForResult(cameraIntent, CAMERA_REQUEST)
                        }
                    }
                }
                ...
                Toast.makeText(this@ChatSingleActivity, "error ${it.message}", Toast.LENGTH_LONG).show()
        ...
        btnMicrophone.setOnTouchListener { view, motionEvent ->
            when (motionEvent.action) {
                MotionEvent.ACTION_DOWN -> {
                    ...
                    if (ContextCompat.checkSelfPermission(this@ChatSingleActivity, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        voiceMessageHelper.start(presenter.opponentName, presenter.channel?.sid ?: presenter.channelSid)
                    }
                    true
                }
