...
class SplashActivity : BaseInjectActivity() {
    ...
    @Inject lateinit var model: SettingsModel
    @Inject lateinit var callModel: CallModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.e("isPhoneVerified = ${prefs.getObject(Preference.KEY_USER_PHONE_VERIFIED, Boolean::class.java)}")
        Timber.e("push token = ${FirebaseInstanceId.getInstance().token}")
...
//        startActivity(intent)
        ...
        firebaseToken?.let {
            val oldToken = prefs.getObject(Preference.KEY_FIREBASE_ID, String::class.java) ?: ""
...
//                prefs.putObject(Preference.KEY_FIREBASE_ID, it, String::class.java)
                ...
                model.updateFirebaseToken(firebaseToken)
                    .subscribe(
                        {
...
//            }
    ...
    private fun restoreUserMetadata() {
        ...
        val userMainPhoto = prefs.getObject(Preference.KEY_USER_MAIN_PHOTO, String::class.java) ?: ""
        ...
        val userLockerType = prefs.getObject(Preference.KEY_USER_LOCKER_TYPE, String::class.java) ?: ""
        val userLockerValue = prefs.getObject(Preference.KEY_USER_LOCKER_VALUE, String::class.java) ?: ""
